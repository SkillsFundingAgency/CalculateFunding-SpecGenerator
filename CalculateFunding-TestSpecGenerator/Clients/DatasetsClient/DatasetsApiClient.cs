namespace CalculateFunding.Frontend.Clients.DatasetsClient
{
    ...
    public class DatasetsApiClient : BaseApiClient, IDatasetsApiClient
    {
        ...
        public Task<ApiResponse<DatasetValidationStatusModel>> GetDatasetValidateStatus(string operationId)
        {
            Guard.IsNullOrWhiteSpace(operationId, nameof(operationId));

            return GetAsync<DatasetValidationStatusModel>($"get-dataset-validate-status?operationId={operationId}");
        }
    }
}
